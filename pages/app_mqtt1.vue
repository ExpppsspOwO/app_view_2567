                        ...
                        <v-row>
                            ...
                            <v-col cols="12" sm="6">
                                <v-card style="border-radius: 15px;" class="pa-3" hover outlined>
                                    ...
                                    <v-card-text class="text-center">
                                        <v-progress-circular :model-value="value_temp" size="150" width="20"
                                            color="red">
                            ...
                            <v-col cols="12" sm="6">
                                <v-card style="border-radius: 15px;" class="pa-3" hover outlined>
                                    ...
                                    <v-card-text class="text-center">
                                        <v-progress-circular :model-value="value_humi" size="150" width="20"
                                            color="blue">
                                            {{ value_humi }} %
                                        </v-progress-circular>
                                    </v-card-text>
                        ...
                        <v-row class="mt-5">
                            ...
                            <v-col cols="12" sm="6">
                                <v-card style="border-radius: 15px;" class="pa-3" hover outlined>
                                    ...
                                    <v-card-text class="text-center">
                                        <v-progress-circular :model-value="totalValueT()" size="150" width="20"
                                            color="amber">
                                            {{ totalValueT() }} °C
                                        </v-progress-circular>
                                        <v-row class="mt-3">
                            ...
                            <v-col id="button-section" cols="12" sm="6">
                                <v-card style="border-radius: 15px;" class="pa-3" hover outlined>
                                    ...
                                    <v-card-text class="text-center">
                                        <v-progress-circular :model-value="totalValueH()" size="150" width="20"
                                            color="green">
                                            {{ totalValueH() }} %
                                        </v-progress-circular>
                                        <v-row class="mt-3">
            ...
            <v-col cols="12" md="8">
                <v-card style="border-radius: 15px;" class="pa-5" hover outlined>
                    <v-row justify="space-around" class="mb-5">
                        <v-col cols="12" sm="5">
                            <v-btn block color="green" class="white--text" large @click="start"
                                style="border-radius: 15px;height: 50px;">
                                เริ่มต้น
                            </v-btn>
                        </v-col>
                        <v-col cols="12" sm="5">
                            <v-btn block color="red" class="white--text" large @click="stop"
                                style="border-radius: 15px;height: 50px;">
                                หยุด
                            </v-btn>
                        </v-col>
                    ...
                    <v-card-text>
                        ...
                        <v-row class="justify-center">
                            ...
                            <v-col cols="6" class="text-center">
                                <v-icon :color="temperatureStatus() === 'hot' ||  temperatureStatus() === 'quite hot' ? 'green': 'grey'" style="font-size: 48px;">mdi-water</v-icon>
                                <div>สปริงเกอร์</div>
                            </v-col>
                        </v-row>
                        ...
                        <v-row class="mt-5">
                            <v-col cols="12" sm="6">
                                ...
                                <h3>อยู่ในระดับที่ <h3 style="display:inline;color: red;font-size: 18px">{{ systemStatus
                                        }}</h3>
                                </h3>
                            </v-col>
                            ...
                            <v-col cols="12" sm="6">
                                ...
                                <h3>อยู่ในระดับที่ <span style="display:inline;color: blue;font-size: 18px">{{
                                    systemStatus1
                                        }}</span></h3>
                            </v-col>
                        </v-row>
                        ...
                        <v-progress-linear :model-value="value_temp" color="deep-orange" height="20" striped
                            class="mb-3"></v-progress-linear>
                        <v-progress-linear :model-value="value_humi" color="light-blue" height="20" striped
                            class="mb-3"></v-progress-linear>
                        <v-progress-linear :model-value="totalValue()" color="lime" height="20"
                            striped></v-progress-linear>
                        <v-divider class="my-5"></v-divider>
                        <div class="text-center mt-3">
                            <strong>ผลรวม: {{ totalValue() }}</strong>
                        </div>
                    </v-card-text>
                </v-card>
            </v-col>
            ...
            <v-col cols="12" md="8">
                <v-card style="border-radius: 15px;" class="pa-5" hover outlined>
                    <v-row>
                        ...
                        <v-col cols="12" sm="4">
                            <v-card style="border-radius: 15px;" class="pa-3" hover outlined>
                                <v-card-title class="text-center">Test Control</v-card-title>
                                <v-card-text>
                                    <v-btn block color="yellow" :disabled="!isOn" @click="cycleLights" class="mb-3">
                                        {{ numericValueState() }}
                                    </v-btn>
                                </v-card-text>
                            </v-card>
                                ...
                                <v-card-text>
                                    <v-row justify="center">
                                        <v-col cols="4" class="text-center">
                                            <v-icon :color="lightStates[0] ? 'red' : 'grey'" style="font-size: 48px;">
                                                mdi-lightbulb
                                            </v-icon>
                                            <div>ร้อน</div>
                                        </v-col>
                                        <v-col cols="4" class="text-center">
                                            <v-icon :color="lightStates[1] ? 'green' : 'grey'" style="font-size: 48px;">
                                                mdi-lightbulb
                                            </v-icon>
                                            <div>ปกติ</div>
                                        </v-col>
                                        <v-col cols="4" class="text-center">
                                            <v-icon :color="lightStates[2] ? 'blue' : 'grey'" style="font-size: 48px;">
                                                mdi-lightbulb
                                            </v-icon>
                                            <div>เย็น</div>
                                        </v-col>
                        ...
                        <v-col cols="12" sm="8">
                            <v-card style="border-radius: 15px;" class="pa-3" hover outlined>
                                ...
                                <v-card-text>
                                    <v-row justify="center">
                                        <v-col cols="4" class="text-center">
                                            <v-icon :color="lightStates1[0] ? 'red' : 'grey'" style="font-size: 48px;">
                                                mdi-lightbulb
                                            </v-icon>
                                            <div>แห้ง</div>
                                        </v-col>
                                        <v-col cols="4" class="text-center">
                                            <v-icon :color="lightStates1[1] ? 'green' : 'grey'"
                                        ...
                                        <v-col cols="4" class="text-center">
                                            <v-icon :color="lightStates1[2] ? 'blue' : 'grey'" style="font-size: 48px;">
                                                mdi-lightbulb
                                            </v-icon>
                                            <div>ชื้น</div>
                                        </v-col>
