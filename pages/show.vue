<template>
  ...
  <v-data-table :headers="headers" :items="desserts" :search="search" :sort-by="[{ key: 'id', order: 'asc' }]">
    <template v-slot:top>
      <v-toolbar flat>
            ...
            <v-card-text>
              <v-container>
                <v-row>
                  ...
                  <v-col cols="12" md="4" sm="6">
                    <v-text-field v-model="editedItem.username" label="usersname"></v-text-field>
                  </v-col>
                  <v-col cols="12" md="4" sm="6">
