<template>
    <!-- <v-navigation-drawer>
        <v-list>
            <v-list-item title="IOT BY IT_D1">
                <v-card class="mx-auto" max-width="500" style="text-align: center;">
                    <v-card-title>
                        CONTROL
                    </v-card-title>
                    <div>
                        <v-btn block style="background-color: greenyellow;color: #fff;" @click="start">Start</v-btn>
                        <br>
    ...
    <!-- <v-parallax src="../img/banner3.png"> -->
    <br>
            ...
            <v-row>
                ...
                <v-col cols="12" sm="12" md="4">
                    <v-card class="mx-auto" max-width="300" hover style="border-radius: 15px;">
                        <v-card-title>
                            <h3 style="text-align: center;">TEST Control</h3>
                        </v-card-title>
                        <v-card-text>
                            <v-row>
